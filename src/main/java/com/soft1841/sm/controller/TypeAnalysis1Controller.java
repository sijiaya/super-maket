...
public class TypeAnalysis1Controller implements Initializable {
    @FXML
    private StackPane pieCharPane, barChartPane;
    ...
    private void initBarChart() {
        ...
        for (Type type : typeList) {
            ...
            series1.getData().add(new XYChart.Data(type.getName(), count));
    ...
    private void initPieChart() {
        ...
        for (Type type : typeList) {
            int count =goodsService.countByType(type.getId());
            pieChartData.add(new PieChart.Data(type.getName(), count));
        }
